    ...
    def __plot_titles(self, ax, title):
        ...
        if title.get('title_name'):
            ...
            ax.text(-22, 24, title['title_name'], fontsize=title['title_fontsize'], fontweight='bold', 
                    fontdict={'color': title['title_color']}, ha = "center",fontfamily=self.fontfamily)
        ...
        if title.get('title_name_3'):
            ## plot the second title name
            ax.text(22, 24, title['title_name_3'], fontsize=title['title_fontsize_3'], fontweight='bold', 
                    fontdict={'color': title['title_color_3']}, ha='right', fontfamily=self.fontfamily)
        
        if title.get('subtitle_name_3'):
            ## plot the second subtitle name
            ax.text(22, 22, title['subtitle_name_3'], fontsize=title['subtitle_fontsize_3'], 
                    fontdict={'color': title['subtitle_color_3']}, ha='right', fontfamily=self.fontfamily)             
        
        if title.get('title_fontsize_4') == None:
            ## add title fontsize 2
            title['title_fontsize_4'] = title['title_fontsize']

        if title.get('subtitle_fontsize_4') == None:
            ## add subtitle fontsize 2
            title['subtitle_fontsize_4'] = title['subtitle_fontsize']

        if title.get('title_color_4') == None:
            ## add title color
            title['title_color_4'] = '#000000'
        
        if title.get('subtitle_color_4') == None:
            ## add subtitle color
            title['subtitle_color_4'] = '#000000'
        
        if title.get('title_name_4'):
            ## plot the second title name
            ax.text(22, 24, title['title_name_4'], fontsize=title['title_fontsize_4'], fontweight='bold', 
                    fontdict={'color': title['title_color_4']}, ha='right', fontfamily=self.fontfamily)
        
        if title.get('subtitle_name_4'):
            ## plot the second subtitle name
            ax.text(22, 22, title['subtitle_name_4'], fontsize=title['subtitle_fontsize_4'], 
                    fontdict={'color': title['subtitle_color_4']}, ha='right', fontfamily=self.fontfamily) 

        if title.get('title_fontsize_5') == None:
            ## add title fontsize 5
            title['title_fontsize_5'] = title['title_fontsize']

        if title.get('subtitle_fontsize_5') == None:
            ## add subtitle fontsize 5
            title['subtitle_fontsize_5'] = title['subtitle_fontsize']

        if title.get('title_color_5') == None:
            ## add title color
            title['title_color_5'] = '#000000'
        
        if title.get('subtitle_color_5') == None:
            ## add subtitle color
            title['subtitle_color_2'] = '#000000'
        
        if title.get('title_name_5'):
            ## plot the second title name
            ax.text(22, 24, title['title_name_5'], fontsize=title['title_fontsize_5'], fontweight='bold', 
                    fontdict={'color': title['title_color_5']}, ha='right', fontfamily=self.fontfamily)
        
        if title.get('subtitle_name_5'):
            ## plot the second subtitle name
            ax.text(22, 22, title['subtitle_name_5'], fontsize=title['subtitle_fontsize_5'], 
                    fontdict={'color': title['subtitle_color_5']}, ha='right', fontfamily=self.fontfamily)       
        return ax
